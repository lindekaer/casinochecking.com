	...
	<a href="<?php the_permalink(); ?>">
		<div class="row">
			...
			<div class="small-offset-2 columns small-10">
				<p><?php echo the_field('signup_bonus'); ?>% <?php echo _e('up to', 'checkmate');?> <span class="numeric-sidebar-currency fade-in" data-value="<?php the_field('up_to_signup'); ?>"> <?php the_field('up_to_signup'); ?></span><span class="currency-type"></span></p>
			</div>
		</div>
	</a>
</div>