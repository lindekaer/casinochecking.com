<a class="fav-casino" href="<?php the_permalink(); ?>">
    <div class="row">
        ...
        <div class="small-offset-2 columns small-10">
            <p><?php echo the_field('signup_bonus'); ?>% <?php echo _e('up to', 'checkmate'); ?> <span
                        class="numeric-sidebar-currency"
                        data-value="<?php the_field('up_to_signup'); ?>"> <?php the_field('up_to_signup'); ?></span><span
